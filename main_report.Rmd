...
institute:
  - jrc: "`r ifelse(!params$anonymous, 'European Commission, Joint Research Centre, Brussels, Belgium', 'Anonymous Institute 1') `"
  - harvard: "`r ifelse(!params$anonymous, 'Harvard University, Berkman Klein Center, Cambridge, MA, USA', 'Anonymous Institute 2')`"
