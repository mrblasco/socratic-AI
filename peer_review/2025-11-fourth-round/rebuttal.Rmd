...
We thank the editor for the opportunity to resubmit our work. We have revised the manuscript addressing Reviewer's comments in two fundamental ways. First, we conducted text analysis of the conversations between the AI and the students, as suggested. The analysis aimed to (1) clairfy the pedagogical difference between Socratic AI and non-Socratic AI, (2) compute additional metrics of students engagment based on the text, and (3) explore possible explanations for the limited effect on learning of the Socratic AI.

The analysis provides several novel insights. First, it confirms that Socratic AI uses relevant Socratic pedagogical principles, such as an encouraging tone, supports students without providing answer, and encourages them with questions on the next steps, significantly more than the non-Socratic AI. Second, the analysis confirms higher level of engagement of students in Socratic AI, controlling for the number of exchanges. Third, it also revealed that Socratic AI scored lower in terms of clarity and depth of learning. This suggest a plausible explanation for the Socratic AI's lack of significant learning effects, despite the higher engagement. In other words, the text analysis suggests that the gains in terms of engagement with short and frequent exchanges were possibly offset by a lower overall clarity and depth in the responses.

Finally, we have also edited (i) the discussion regarding the interpretation of the findings about the Socratic LLM and (ii) the conclusions to present statements in a more modest manner avoiding overstatements.
...
We thank the reviewer for this thoughtful and constructive critique. We have revised the manuscript to clarify our rationale for presenting the two experiments within a single study.

As outlined in the revised Introduction, Experiment 1 establishes an empirical baseline that is essential for interpreting Experiment 2. The Non-Socratic AI condition in Experiment 2 employs the same type of AI-generated explanations used in Experiment 1. Thus, the initial experiment validates that these explanations are pedagogically meaningful and sets the foundation for exploring how instructional framing modulates their effectiveness in Experiment 2.
...
Prior work on discovery learning and explanation-based instruction highlights not only the benefits of explanations but also the conditions under which learners may fail to engage with them productively [see @lee2013student for a review]. Our setting differs fundamentally from teacher-led instruction, as generative AI provides students with an immediate, complete solution and, depending on the experimental condition, an explanation. In this setting, learners may rely solely on the final answer or, conversely, overtrust the AI because an explanation is present, without realling engaging in any critical thinking. These dynamics are not present in the same way in traditional classroom contexts.

Accordingly, Experiment 1 demonstrates that:
...
(2) such explanations alone do not appear to meaninguflly influence students’ trust in the AI agent, an important factor given ongoing concerns that students may either overtrust AI or ignore explanations and simply copy solutions.
...
We conducted a detailed text analysis of all AI–student conversations. The goal was to (a) clarify the actual pedagogical differences between the Socratic and Non-Socratic agents as they emerged in practice, (b) derive additional indicators of student engagement that go beyond simple word counts, and (c) investigate why the Socratic AI agent, despite producing more conversational exchanges, did not yield stronger learning outcomes.
...
We thank the reviewer for this important distinction. We now use the followign taxonomy. We call an "AI tutor" a trained LLM based on pedagogical principles and tested theories. Instead, an "AI agent" is a general-purpose LLM with instructions to follow a particular type of interactions. We now call our intervention AI agents throughout the manuscript. We have also highlighted more in detail the process of development of the AI agents, both in the Intro and in the Methods (see Table with instructional prompts). 
...
Yet, the findings obtained by our research, especially in the trade-offs between explanations and self-explanations are vaulablie insights for the development of such app.
...
We thank you for your suggestion, we have conducted the text-analysis to improve the study to gain more insights into students' actions, as discussed above. 
